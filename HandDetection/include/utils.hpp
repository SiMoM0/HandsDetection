...
/*
 * In this project we used variables generated by CMake to set the location of file to load
 * DATASET_PATH = path of the rgb images of the dataset (string)
 * BBOX_PATH = path of the bounding boxes of the images of the dataset (string)
 * MASK_PATH = path of the masks of the images of the dataset (string)
 * MODEL_PATH = path of the onnx model used for detection (string)
 * These variables allow us to dinamically know the path of our file despite of the project organization
 */
const std::string DATASET_PATH = DATASET_PATH_CM;
const std::string BBOX_PATH = BBOX_PATH_CM;
const std::string MASK_PATH = MASK_PATH_CM;
const std::string NETWORK_PATH = MODEL_PATH_CM;
